...
public class SizeFruitFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_size_fruit, parent, false);
        ...
        mMediumButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Singleton.getInstance().setPrice("Total a pagar: $ "+mSizeM +" pesos 00/100 M.N)");
                Intent intent = new Intent(getActivity(), TakeawayActivity.class);
                startActivity(intent);
            }
        });
